...
The pipeline is divided into two layers:

- [`ibis2ibstoml`](https://docs.rs/ibis_parser/latest/ibis_parser/ibis2ibstoml/) — First-pass format reshaping layer. Tokenises IBIS text via
  PEST grammar, classifies keywords, builds a section tree, and serialises to TOML.
  All values remain as raw strings; no numerical conversion or unit scaling is performed.
